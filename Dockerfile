...
ARG NEXT_PUBLIC_POWERED_BY_URL
ARG NEXT_PUBLIC_SOURCE_CODE_URL
ARG NEXT_PUBLIC_FORCE_LOCALE
...
ENV NEXT_PUBLIC_WEBAPP_URL=http://NEXT_PUBLIC_WEBAPP_URL_PLACEHOLDER \
  ...
  NEXT_PUBLIC_POWERED_BY_URL=$NEXT_PUBLIC_POWERED_BY_URL \
  NEXT_PUBLIC_SOURCE_CODE_URL=$NEXT_PUBLIC_SOURCE_CODE_URL \
  NEXT_PUBLIC_FORCE_LOCALE=$NEXT_PUBLIC_FORCE_LOCALE \
